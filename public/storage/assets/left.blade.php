<div class="col-sm-3" id="SearchPost">
    <div class="green-outer me-5">
        <div class="green-box" @if(isset($data['user_information'])) style="background-image: url({{ asset('public/user_media/' . $data['user']->id . '/profile_picture/' . $data['user_information']->profile_picture) }});" @else style="background-image: url({{ asset('storage/assets/images/profile.jpeg')}});" @endif>
                ...
                <a href="" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"
                    ...
                    <form class="dropdown-menu p-4 editDropdown" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="greenemail">
                            ...
                            <p>Country: <span class="float-end">{{ isset($data['user_information']->country) ? $data['user_information']->country : '' }}</span></p>
