...
const getViewRelatievPath = window.location.pathname.split("/")[1]

window.addEventListener("load", ()=>{
  if(getViewRelatievPath == "view-relative-post"){
    document.querySelector(".content .container .col-sm-6").classList.add("ViewPrivatePost")
  }
})