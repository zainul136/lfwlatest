                            ...
                            <div class="row1 cards d-flex position-relative" style="height: 300px; align-items: flex-end;">
                                ...
                                <a onclick="GetLocation(39.29,-76.831)" class="card">
                                    ...
                                    <div class="card-body d-flex justify-content-center align-items-center ">
                                        <p class="tag">{{$g->relationship_id}}</p>
                                        <p class="name">{{$g->first_name}}</p>
                                        <p>
                                            <span>Age: {{$g->last_name}}</span> <br>
                                            <span> {{$g->email}} <img src="./images/BG.png" class="flag" alt=""></span>
                                        </p>
                                    </div>
                                    <div class="line"></div>
                               ...
                               @if(count($parents)>0)
                                ...
                                <a onclick="GetLocation(39.2, -76.641)" class="card bg-white">
                                    <div class="img d-flex justify-content-center align-items-center">
                                        ...
                                        <img src="{{asset('user_media\100\profile_picture\6521384da353a.png')}}" class="card-img-top" alt="...">
                                        <div class="circle">
            ...
            <ul>
                <li>
                    ...
                    <ul class="active">
                        ...
                        <!-- member 1 li start -->
                        <!-- this member 1 belongs to first user -->
						@if(count($sibling)>0)
                        ...
                        <!-- member 1 li end -->
                        <!-- member 2 li start -->
                        <!-- this member 2 belongs to first user -->
                        
                        <!-- member 2 li end -->
                        <!-- member 3 li start -->
                        <!-- this member 3 belongs to first user -->
                        <li>
                        ...
                        <!-- member 4 li start -->
                        <!-- this member 4 belongs to first user -->
                        <li>
				...
				<div class="card-header border-0 flex-wrap pb-0">
					...
					<div class="d-flex flex-wrap mb-2">
						<div class="form-check me-4 mb-2">
						  ...
						  <label class="form-check-label" for="flexCheckDefault1"><span class="d-block  font-w500">BTS</span></label>
						</div>
						<div class="form-check me-4 mb-2">
						  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault2">
						  <label class="form-check-label" for="flexCheckDefault2"><span class="d-block  font-w500">XRP</span></label>
						</div>
						<div class="form-check me-4 mb-2">
						  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault3">
						  <label class="form-check-label" for="flexCheckDefault3"><span class="d-block  font-w500">ETH</span></label>
						</div>
						<div class="form-check me-4 mb-2">
						  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault4">
						  <label class="form-check-label" for="flexCheckDefault4"><span class="d-block  font-w500">ZEC</span></label>
						</div>
					</div>
									...
									<div class="row mt-4 align-items-center">
										...
										<div class="col-lg-6">
											<div class="d-flex justify-content-end">
												...
												BUY
													<svg class="ms-3 scale3" width="16" height="16" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<a href="javascript:void(0);" class="btn btn-danger ms-3 text-nowrap">
												SELL
													<svg class="ms-3 scale5" width="16" height="16" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
