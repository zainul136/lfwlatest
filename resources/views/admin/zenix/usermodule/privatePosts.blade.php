...
@section('content')
    <div class="container-fluid">
        <div class="form-head d-flex align-items-center flex-wrap justify-content-between mb-sm-5 mb-3">
            <h2 class="font-w600 mb-0 text-black">Private Posts</h2>
        </div>
        ...
        <div class="row">
                ...
                <div class="table-responsive table-hover fs-14 bg-white">
                    <div class="table-before-first">
                        <div class="search-bar-container">
                            ...
                            <input id="private-post-search-input" type="text" class="form-control user-search-bar" placeholder="search for users">
                        </div>
                    ...
                    <table class="table display mb-4 dataTablesCard short-one card-table text-black" id="example6">
                        ...
                        <tbody id="private-post-info-tbody">
                        @if(isset($posts))
                        ...
                        <tr>
                            ...
                            <td>
                                <div
                                        style="padding: 10px 10px; width: 130px; color: #0373A4; background-color: rgba(3, 115, 164, 0.24); border-radius: 24px; text-align: center;">
                                    {{$post->post_type ??''}}
                                </div>
                            </td>
                            <td>{{ \Carbon\Carbon::parse($post->created_at)->format('M j, Y h:i A') }}</td>
                            <td class="table-action-tr">
                                <a class="text-black font-w600">
                                    <svg class="table-action-tr-first message-content-view-btn"
                                ...
                                <a href="{{ route('edit-private-posts',$post->id) }}">
                                ...
                                <a href="#">
                                    <svg class="table-action-tr-second remove remove-public-post" width="19" height="18"
                                    ...
                                    <!-- The Modal -->
                                    <div id="message-modal" class="modal-box">
            ...
            align-items: center;">
                                    ...
                                    <!-- The Remove Public Post Modal -->
                                    <div id="remove-public-post-modal" class="modal-box">
                                        <!-- Modal content -->
                                        <div class="modal-content">
                                            <div class="modal-content-first">
                                            ...
                                            <div class="modal-cancwl-del-container">
                                                <button class="modal-cancel-btn remove-public-post-close">Cancel</button>
    ...
    <script>
        $(document).ready(function () {
            var $searchInput = $("#private-post-search-input");

            $searchInput.on("input", function () {
                var searchTerm = $searchInput.val().toLowerCase();

                // Loop through each table row
                $("#private-post-info-tbody tr").each(function () {
                    var $row = $(this);
