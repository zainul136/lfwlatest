...
<head>
    ...
    <meta property="og:title" content="Last Few Word - Admin Dashboard" />
    ...
    <title>Last Few Words| @yield('title', $page_title ?? '')</title>
    <!-- Favicon icon -->
    ...
    @php
        ...
        $configKey = 'dz.public.pagelevel.css.'.$action;
        $configValue = Config::get($configKey);
       
        $configGlobal = 'dz.public.global.css';
        $configGlobalValue = Config::get($configGlobal);
    @endphp
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.18/dist/css/bootstrap-select.min.css" rel="stylesheet"> -->
  
    @if(!empty($configValue))
        @foreach($configValue as $style)
            <link href="{{ asset($style) }}" rel="stylesheet" type="text/css"/>
        @endforeach
    @endif

    {{-- Global Theme Styles (used by all pages) --}}
    @if(!empty($configGlobalValue))
        @foreach($configGlobalValue as $style)
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                ...
                <img src="{{ asset('storage/assets') }}/images/logosvg1.svg" alt="" style="height: 65px">
    ...
    ***********************************-->
    ...
    <!--**********************************
        Scripts
    ***********************************-->
	@include('admin.elements.footer-scripts')
