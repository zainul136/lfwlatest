...
@section('header')
    ...
    <style>
        ...
        section .card-layout .card-bottom{
                    ...
                    <div class="tag mt-4 me-3">
                        ...
                        <div class="tagsrow">
                            @foreach ($data['tags'] as $tag)
                                <div class="tagx-item">
                                    <a style="text-decoration: none;" href="{{url('deceasedProfile/'. $data['user']->id.'/tag/'. $tag->slug) }}"><button>{{ $tag->name }}</button></a>
                                </div>
                            @endforeach
                        </div>
                    </div>
                                                    ...
                                                    @if ($post->tags->count() > 0)
                                                        <div class="card-top-desc-tags">
                                                            @foreach ($post->tags as $tag)
                                                                <span>
                                                                    <a href="{{ url('deceasedProfile/'. $data['user']->id.'/tag/'. $tag->slug) }}">#{{ $tag->name }}</a></span>
                                                            @endforeach
                                                        </div>
                                                    @endif
                                                </div>
                                                ...
                                                <div class="card4-content">
                                                    @if (isset($post->PostVideo->video_path))
                                                        ...
                                                        <video id="myVideo" width="640px" height="360px" controls>
                                                            <source src="{{ asset($post->PostVideo->video_path) }}" type="video/@php echo "$extension"; @endphp">
                                                        </video>
...
{{--                                                            </div>--}}
{{--                                                            <div class="card-bottom-right-navbtn">--}}
{{--                                                                <img class="catLeft" src="{{ asset('storage/assets/posts') }}/img/next.svg" alt="">--}}
{{--                                                            </div>--}}
{{--                                                            <div class="card-bottom-right-tags">--}}
{{--                                                                @foreach ($post->viewers as $viewer)--}}
{{--                                                                    <span><a href="#">{{ $viewer->first_name }}{{ $viewer->last_name }}</a></span>--}}
{{--                                                                @endforeach--}}
{{--                                                            </div>--}}
{{--                                                            <div class="card-bottom-right-navbtn">--}}
{{--                                                                <img class="catRight" src="{{ asset('storage/assets/posts') }}/img/next.svg" alt="">--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                    @endif--}}
                                                </div>
                                            ...
                                            <div class="card-layout">
                                                ...
                                                <div class="card-top">
                                                    <div class="card-top-text">
                                                        <div class="card-top-left">
                                                            @if (isset($data['user_information']->profile_picture))
                                                                <img class="avatar" src="{{ asset('user_media/' . $data['user']->id . '/profile_picture/' . $data['user_information']->profile_picture) }}" />
                                                            @else
                                                                <img class="avatar" src="{{ asset('storage/assets/images/profile.jpeg') }}" />
                                                            @endif
                                                    ...
                                                    <div class="card-top-desc">
                                                        ...
                                                        @if ($post->tags->count() > 0)
                                                            <div class="card-top-desc-tags">
                                                                @foreach ($post->tags as $tag)
                                                                    <span><a href="{{ url("tag/$tag->slug") }}">#{{ $tag->name }}</a></span>
                                                                @endforeach
                                                            </div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="card-top-desc">
                                                        ...
                                                        @if ($post->tags->count() > 0)
                                                            <div class="card-top-desc-tags">
                                                                @foreach ($post->tags as $tag)
                                                                    <span><a
                                                                                href="{{ url("deceasedProfile/tag/$tag->slug") }}">#{{ $tag->name }}</a></span>
                                                                @endforeach
                                                            </div>
                                                        @endif
                                                    </div>
                                                            ...
                                                            <div class="images " >
                                                                ...
                                                                @if (count($imagePaths) > 1)
                                                                    @foreach ($imagePaths as $index => $imagePath)
                                                                        ...
                                                                        <img onclick="OpenImageModal(event, true,'{{ asset('user_media/' . $post->user_id . '/images/' . $imagePath) }}', 'card2contentunique<?=$rand?>')"
