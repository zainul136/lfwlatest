...
@section('content')
    {{-- TM Custom --}}
    @if(!auth()->user()->hasSubscription($relative['user']->id))
        <style>
            .tm_popup .tm_overlay{
                position: fixed;
                z-index: 10;
            ...
            .tm_popup .main_content .button-container{
            ...
            .tm_popup .main_content a:nth-child(1){
            ...
            .tm_popup .main_content .row.mt-2 .col-4.offset-1.mt-4 {
                width: max-content;
                margin: 0;
            ...
            .tm_popup .main_content .row.mt-2 {
                justify-content : center;
            }
            .tm_popup .main_content .row.mt-2 .col-2.offset-2{
                margin: 0;
                width: max-content;
            }
            @media screen and (max-width : 992px) {
                ...
                .tm_popup .main_content .row.mt-2 h3.text-center{
                    font-size : 22px
                }
        ...
        <div class="tm_popup tm_subscription_popup">
            <div class="tm_overlay"></div>
            <div class="main_content">

                <h3 class="text-center" style="font-size: 30px;">Profile Information</h3>
                <div class="row mt-2">
                    <div class="col-2 offset-2"  style=" margin-right:3%;">
                        <img src="{{asset('user_media/'.$relative['user']->id.'/profile_picture/'.$relative['user']->userInformation->profile_picture) ??''}}" height="100" width="100" style="border-radius: 10%">
                    </div>
                    <div class="col-4 offset-1 mt-4 " style="text-align: left; ">
                        <span class="text-left"  style=" margin-right:-5%; font-size: 16px;font-weight: 500;margin-bottom: 0;color: #999999;">{{ $relative['user']->getFullName() ??''}}</span>
                        <span  style="font-size: 16px;font-weight: 500;margin-bottom: 0;color: #999999;">{{$relative['user']->email ??''}}</span>
                    </div>

                    <p class="mt-4 mb-4 text-center" style="font-size: 16px;font-weight: 500;margin-bottom: 0;color: #999999;">This profile is locked, in order to view profile, you need to pay Unlock Fee by clicking on "Unlock"
                        Button below.</p>
                </div>

                <div class="row mt-3" style="display: flex; ">
                    <div class="button-container" style="display: flex;">
                        <a href="{{ route('subscribe.profile', $relative['user']->id) }}" style="font-size: 12px;line-height: 18px;background: #99DDCC;border: 0;border-radius: 9px;color: white; box-shadow: 0px 4px 10px rgba(51, 51, 51, 0.1);" >Unlock Profile</a>
                        <a href="{{ route('home') }}" style="margin-left: -20%; font-size: 12px;line-height: 18px;background: #99DDCC;border: 0;border-radius: 9px;color: white; box-shadow: 0px 4px 10px rgba(51, 51, 51, 0.1);" >Home</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @if(!auth()->user()->hasSubscription($relative['user']->id))
                            <div class="something mt-4">
                                <div class="d-flex mt-2 flex-column align-items-center">
                                    <h3 class="text-center" style="text-align: center !important;">You need a subscription pal...</h3>
                                    <p><a href="{{ route('subscribe.profile', $relative['user']->id) }}">Click Here</a> to subscribe</p>
                                </div>
                            </div>
                        @else
                            ...
                            @if ($data['posts']->isEmpty())
                                <div class="something mt-4">
                                    <div class="d-flex mt-2">
                                        <p class="text-center" style="text-align: center !important;">No Posts Found</p>
                                    </div>
                                </div>
                            @else
                                                ...
                                                @if ($post->post_scope == 'private')
                                                    <div class="card-bottom">
                                                        <div class="card-bottom-left">
                                                            ...
                                                            <button>
                                                                <img src="{{ asset('storage/assets/posts') }}/img/private.svg" alt="">Private</button>
                                                        </div>
                                    ...
                                    @elseif($post->post_type == 'images' || $post->post_type == 'text/images')
                                        ...
                                        @if ($post->PostImage)
                                            ...
                                            <section id="{{ $post->id  }}">
                                                ...
                                                <div class="card-layout imgcarousel" id="imgcarousel<?=$rand?>" style="min-height: 818px;height: 90vh;">
                                                    <div class="card-top">
                                                        <div class="card-top-text">
                                                            <div class="card-top-left">
