...
class ZenixadminController extends Controller
{
    ...
    public function dashboard_1()
    {
        ...
        $family_users = DB::table('users')
                        ->join('user_relationships','users.id','user_relationships.user_id')
                        ->where('users.id','100')
                        ->orwhere('user_relationships.relative_id','100')
                        ->orwhere('user_relationships.user_id','100')
                        ->get();
        
        // get all relation -->done 
        // separate arrays according to relations
        // relationship 2 is sister 1 is brother both are siblings 
        // uncle aunti should b in parents array
        $nodeUser = User::where('id','100')->first(); 
        $grand =[];
        $sibling =[];
        ...
        foreach($family_users as $user){
            if($user->relationship_id == '9' ){
                array_push($grand,$user);
            }
            elseif($user->relationship_id == '1' || $user->relationship_id =='2'){
                array_push($sibling,$user);
            }elseif($user->relationship_id == '3' || $user->relationship_id =='4' || $user->relationship_id =='14' || $user->relationship_id =='13'){
        ...
        // ],
        // ];
        // // print_r($familyTree['relationships']);exit;
        // $familyTreeJson = json_encode($familyTree);
        // $familyTreeData= $family_users;

// // return $family_users;

        // echo count($children);exit;
        // echo '<pre>';
        //  print_r($parents);exit;
        return view('admin.zenix.dashboard.index', compact('page_title', 'page_description', 'action','sibling','parents','children','nodeUser','grand'));
    ...
    public function deletedUser()
    {
        ...
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.dashboard.deletedUser', compact('page_description', 'action'));
    ...
    public function paymentConfirmation()
    {
        ...
        // $page_title = 'paymentConfirmation';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.dashboard.paymentConfirmation', compact('page_description', 'action'));

    }

    // tranasactions
    public function deceasedRequest()
    {

        // $page_title = 'allTestpending';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.dashboard.deceasedRequest', compact('page_description', 'action'));
    ...
    public function userInformation()
    {
        ...
        $user = User::with('user_information')->latest()->get();
        // echo'<pre>';
        // print_r($user);exit;
        return view('admin.zenix.dashboard.userInformation', compact('page_description', 'action','user'));
    ...
    public function userChats()
    {
        ...
        // $page_title = 'allTestCompleted';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.usermodule.userChats', compact('page_description', 'action'));
    ...
    public function publicPosts()
    {
        ...
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.usermodule.publicPosts', compact('page_description', 'action'));
    ...
    public function privatePosts()
    {
        ...
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.usermodule.privatePosts', compact('page_description', 'action'));

    }

    public function editPublicPost()
    {

        // $page_title = 'allTestCompleted';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.usermodule.editPublicPost', compact('page_description', 'action'));

    }
    public function editPrivatePost()
    {

        // $page_title = 'allTestCompleted';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.usermodule.editPrivatePost', compact('page_description', 'action'));
    ...
    public function user_list_datatable()
    {
        ...
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.user.list_datatable', compact('page_title', 'page_description', 'action'));
    }
    ...
    public function user_list_column()
    {
        ...
        $page_title = 'User Card';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.user.list_column', compact('page_title', 'page_description', 'action'));
    ...
    // Form Element
    public function paymentSetForm()
    {
        // $page_title = 'Form Elements';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.form.paymentSetForm', compact('page_description', 'action'));
    }
    // Form Element2
    public function faqForm()
    {
        // $page_title = 'Form Elements 2';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.form.faqForm', compact('page_description', 'action'));
    }
    // Form Element3
    public function form_element3()
    {
        $page_title = 'Form Elements 3';
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.form.element3', compact('page_title', 'page_description', 'action'));
    }
    ...
    public function sendNotification()
    {
        ...
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.dashboard.sendNotification', compact('page_description', 'action'));
    }
    ...
    public function editUser()
    {
        ...
        $page_description = 'Some description for the page';
        $action = __FUNCTION__;
        return view('zenix.dashboard.editUser', compact('page_description', 'action'));
    }
    ...
    {
        return view('zenix.ajax.contact_list');
    }
